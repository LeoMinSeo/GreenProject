      ...
      <main className="flex-1 p-6">
        ...
        <section className="bg-white p-4 shadow-md rounded-lg mb-6">
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              <tr className="border-b">
                <td className="p-2">2024.01.10~2024.03.28</td>
                <td className="p-2">15:15</td>
              </tr>
              <tr className="border-b">
                <td className="p-2">2024.02.08~2024.02.15</td>
  ...
  /* 학사종합신청
        <section className="bg-white p-4 shadow-md rounded-lg mb-6">
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b">
                <th className="p-2">업무구분</th>
                <th className="p-2">신청양식</th>
                <th className="p-2">학년도</th>
                <th className="p-2">학기</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b">
                <td className="p-2">학적</td>
                <td className="p-2 text-red-500 cursor-pointer">
                  학적부정정 신청
                </td>
                <td className="p-2">2025</td>
                <td className="p-2">1 (하계 포함)</td>
              </tr>
            </tbody>
          </table>
        </section> */
